...
const winPhrases = ['Bananas!!', 'You win', 'Great', 'Wonderful', 'How did you do that!', 'Epic', 'This will be remembered', 'Historic crossing', 'What a dodge!', 'Look at you!', 'Champ', 'BUG-CRUSH', 'Do it. DO IT', 'Viral meme', 'Happy thoughts', 'Winner-winner']
const lossPhrases = ['Mashed', 'Guacamoled', 'Banana split', 'Pureed', 'Bugged infested', 'Wasted youth', 'Give up!', 'Look before you cross', 'reaction level: -30', 'Hold the door', 'Over ran', 'Trashed', 'Trailer parked', 'Lost your marbles','Are you even trying']
